...
describe BinaryGame do
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        valid_input = 5
        verified_number = verify_input.verify_input(min, max, valid_input)
        expect(verified_number).to eq(valid_input)
      end
    end
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        max = verify_input.instance_variable_get(:@maximum)
        invalid_input = 15
        result = verify_input.verify_input(min, max, invalid_input)
  ...
  describe '#maximum_guesses' do
    ...
    context 'when game minimum and maximum is 100 and 600' do
      subject(:game_hundred_to_six_hundred) { described_class.new(100, 600) }
      it 'returns 9' do
        max = game_hundred_to_six_hundred.maximum_guesses
        expect(max).to eq(9)
      end
    end
  end
